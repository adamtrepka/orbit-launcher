/**
 * 3D Simplex noise — compact self-contained implementation.
...
/** Single-sample 3D simplex noise, returns value in [-1, 1]. */
...
/** Fractal Brownian Motion — layered simplex noise, returns ~[-1, 1]. */
